var listSpecialPlaylist = [
	{
		header: {
			...
			image: '/assets/img/tabExplore/specialPlaylists/headerAvatars/playlistList1.jpg',
		},
		playlists: [
			{
				name: 'Những Bài Hát Hay Nhất Của Nguyễn Trọng Tài',
				artists: ['Nguyễn Trọng Tài'],
				image: '/assets/img/tabExplore/specialPlaylists/playlistSongs/playlistList1/playlist1.jpg',
			},
			{
				name: 'Cớ Sao Em Buồn (Single)',
				artists: ['Nguyễn Trọng Tài'],
				image: '/assets/img/tabExplore/specialPlaylists/playlistSongs/playlistList1/playlist2.jpg',
			},
			{
				name: 'Ngừng Mơ (Single)',
				artists: ['Nguyễn Trọng Tài'],
				image: '/assets/img/tabExplore/specialPlaylists/playlistSongs/playlistList1/playlist3.jpg',
			},
			{
				name: 'Hongkong1 (Single)',
				artists: ['Nguyễn Trọng Tài'],
				image: '/assets/img/tabExplore/specialPlaylists/playlistSongs/playlistList1/playlist4.jpg',
			},
			{
				name: 'Cớ Sao Em Buồn (Remixes EP)',
				artists: ['Nguyễn Trọng Tài'],
				image: '/assets/img/tabExplore/specialPlaylists/playlistSongs/playlistList1/playlist5.jpg',
			},
		],
	},
	{
	...
	},
	{
		header: {
			...
			image: '/assets/img/tabRadio/specialPlaylists/headerAvatars/playlistList2.jpg',
		},
		playlists: [
			{
				name: 'Have A Sip',
				artists: [],
				image: '/assets/img/tabRadio/specialPlaylists/playlistSongs/playlistList2/playlist1.jpg',
			},
			{
				name: 'Vietnam Innovators',
				artists: [],
				image: '/assets/img/tabRadio/specialPlaylists/playlistSongs/playlistList2/playlist2.jpg',
			},
			{
				name: 'Bít Tất',
				artists: [],
				image: '/assets/img/tabRadio/specialPlaylists/playlistSongs/playlistList2/playlist3.jpg',
			},
			{
				name: 'M.A.D',
				artists: [],
				image: '/assets/img/tabRadio/specialPlaylists/playlistSongs/playlistList2/playlist4.jpg',
			},
			{
				name: 'Tóm Lại Là',
				artists: [],
				image: '/assets/img/tabRadio/specialPlaylists/playlistSongs/playlistList2/playlist5.jpg',
			},
		],
	},
	{
		...
		playlists: [
			{
				...
				artists: [],
				image: '/assets/img/tabRadio/specialPlaylists/playlistSongs/playlistList3/playlist1.jpg',
			},
			{
				name: 'Chạm x Sao',
				artists: [],
				image: '/assets/img/tabRadio/specialPlaylists/playlistSongs/playlistList3/playlist2.jpg',
			},
			{
				name: 'Chạm x Bạn',
				artists: [],
				image: '/assets/img/tabRadio/specialPlaylists/playlistSongs/playlistList3/playlist3.jpg',
			},
		],
	},
	{
